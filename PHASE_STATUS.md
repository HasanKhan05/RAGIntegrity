...
| Phase 2 — Poisoning Attacks | In Progress | Yes | Yes | No | Expansion ready for final integration: 10 facts, 6 controlled local research PDFs, 30 retrieval-only attack questions, 18 clean controls; 23/30 target-page retrievals; 6-call smoke used 5,551 provider-reported tokens; awaiting final commit and push |
