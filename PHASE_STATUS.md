...
| Phase 2 — Poisoning Attacks | Complete | Yes | Yes | No | Three controlled local research PDFs (not Toyota publications); 6-call run: each target retrieved #1 and each deterministic generation check positive; 5,859 provider-reported total tokens |
